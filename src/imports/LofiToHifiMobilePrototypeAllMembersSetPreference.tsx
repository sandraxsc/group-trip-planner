import svgPaths from "./svg-jl6dwfcqog";
  ...
  return (
    <div className="h-[16px] relative shrink-0 w-[139.234px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Nunito:Black',sans-serif] font-black leading-[16px] relative shrink-0 text-[#afafaf] text-[12px] tracking-[0.3px] uppercase w-[213px]">Start voting trip activities</p>
      </div>
    </div>
  );
}
...
function P() {
  return (
    <div className="content-stretch flex h-[16px] items-start relative shrink-0 w-full" data-name="p">
      <p className="flex-[1_0_0] font-['Nunito:Bold',sans-serif] font-bold leading-[16px] min-h-px min-w-px relative text-[#afafaf] text-[12px]">All members have complete preference setting</p>
    </div>
  );
}
...
function Button() {
  return (
    <div className="bg-[#58cc02] h-[60px] relative rounded-[16px] shrink-0 w-full" data-name="button">
      ...
      <p className="-translate-x-1/2 absolute font-['Nunito:Bold',sans-serif] font-bold leading-[24px] left-[168.5px] text-[16px] text-center text-white top-[18px] tracking-[0.4px] uppercase whitespace-nowrap">Start voting</p>
    </div>
  );
}
...
function Container10() {
  return (
    <div className="bg-[#1cb0f6] relative rounded-[33554400px] shadow-[0px_3px_0px_0px_rgba(0,0,0,0.13)] shrink-0 size-[48px]" data-name="Container">
...
function Circle() {
  return (
    <div className="relative shrink-0 size-[14px]" data-name="Circle">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g clipPath="url(#clip0_13_859)" id="Circle">
          <path d={svgPaths.pc012c00} fill="var(--fill-0, #58CC02)" id="Vector" stroke="var(--stroke-0, #58CC02)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
        </g>
        <defs>
...
function Container12() {
  return (
    <div className="bg-[#ce82ff] flex-[1_0_0] min-h-px min-w-px relative rounded-[33554400px] shadow-[0px_3px_0px_0px_rgba(0,0,0,0.13)] w-[48px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <Span5 />
      </div>
    </div>
...
function Container13() {
  return <div className="bg-[#58cc02] rounded-[33554400px] shrink-0 size-[14px]" data-name="Container" />;
}
...
export default function LofiToHifiMobilePrototypeAllMembersSetPreference() {
  return (
    <div className="bg-white relative size-full" data-name="Lofi to Hifi Mobile Prototype - all members set preference">
      <Body />
      <Div3 />
    </div>
  );
