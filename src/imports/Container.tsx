import svgPaths from "./svg-mj7uewsh9";
  ...
  return (
    <div className="h-[16px] relative shrink-0 w-[139.234px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Nunito:Black',sans-serif] font-black leading-[16px] relative shrink-0 text-[#afafaf] text-[12px] tracking-[0.3px] uppercase w-[213px]">Get start set your trip plan</p>
      </div>
    </div>
  );
}
...
function P() {
  return (
    <div className="content-stretch flex h-[16px] items-start relative shrink-0 w-full" data-name="p">
      <p className="flex-[1_0_0] font-['Nunito:Bold',sans-serif] font-bold leading-[16px] min-h-px min-w-px relative text-[#afafaf] text-[12px]">Invite more friends to the trip</p>
    </div>
  );
}
...
function Button() {
  return (
    <div className="bg-[#58cc02] h-[60px] relative rounded-[16px] shrink-0 w-full" data-name="button">
      ...
      <p className="-translate-x-1/2 absolute font-['Nunito:Bold',sans-serif] font-bold leading-[24px] left-[181.33px] text-[16px] text-center text-white top-[16px] tracking-[0.4px] uppercase whitespace-nowrap">Invite Friends 🚀</p>
    </div>
  );
}
...
function ButtonToAddMoreMembers() {
  return (
    <div className="h-[51px] relative shrink-0 w-full" data-name="button to add more members">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <div className="absolute font-['Balsamiq_Sans:Regular',sans-serif] leading-[16px] left-[7px] not-italic text-[10px] text-black top-[4px] uppercase w-[34px]">
          <p className="mb-0">available</p>
          <p>Slot</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-black border-dashed inset-0 pointer-events-none" />
    </div>
  );
}
  ...
  return (
    <div className="h-[86px] relative shrink-0 w-[48px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center relative size-full">
        <ButtonToAddMoreMembers />
      </div>
    </div>
  );
}

function ButtonToAddMoreMembers1() {
  return (
    <div className="h-[51px] relative shrink-0 w-full" data-name="button to add more members">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <div className="absolute font-['Balsamiq_Sans:Regular',sans-serif] leading-[16px] left-[7px] not-italic text-[10px] text-black top-[4px] uppercase w-[34px]">
...
function Container10() {
  return (
    <div className="h-[86px] relative shrink-0 w-[48px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center relative size-full">
        <ButtonToAddMoreMembers1 />
      </div>
    </div>
  );
}

function ButtonToAddMoreMembers2() {
  return (
    <div className="h-[51px] relative shrink-0 w-full" data-name="button to add more members">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <div className="absolute font-['Balsamiq_Sans:Regular',sans-serif] leading-[16px] left-[7px] not-italic text-[10px] text-black top-[4px] uppercase w-[34px]">
...
function Span4() {
  return (
    <div className="flex-[1_0_0] h-[24px] min-h-px min-w-px relative" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Nunito:Bold',sans-serif] font-bold leading-[24px] left-0 text-[#3c3c3c] text-[16px] top-0 whitespace-nowrap">Set your budget preference</p>
      </div>
    </div>
  );
}
...
function Span5() {
  return (
    <div className="flex-[1_0_0] h-[24px] min-h-px min-w-px relative" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Nunito:Bold',sans-serif] font-bold leading-[24px] left-0 text-[#3c3c3c] text-[16px] top-0 whitespace-nowrap">Choose activity type</p>
      </div>
    </div>
  );
}
...
function Span6() {
  return (
    <div className="flex-[1_0_0] h-[24px] min-h-px min-w-px relative" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Nunito:Bold',sans-serif] font-bold leading-[24px] left-0 text-[#3c3c3c] text-[16px] top-0 whitespace-nowrap">Select places to visit</p>
      </div>
    </div>
  );
}
