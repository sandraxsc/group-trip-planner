import svgPaths from "./svg-srblb1vtan";
import imgImg from "figma:asset/d88aa338c7de1ab45f7ed9859970e25827022679.png";

function Span() {
  return (
    <div className="h-[16px] relative shrink-0 w-[139.234px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Nunito:Black',sans-serif] font-black leading-[16px] relative shrink-0 text-[#afafaf] text-[12px] tracking-[0.3px] uppercase w-[213px]">Set your travel preference</p>
      </div>
    </div>
  );
}
...
function P() {
  return (
    <div className="content-stretch flex h-[16px] items-start relative shrink-0 w-full" data-name="p">
      <p className="flex-[1_0_0] font-['Nunito:Bold',sans-serif] font-bold leading-[16px] min-h-px min-w-px relative text-[#afafaf] text-[12px]">add your opinion to the group</p>
    </div>
  );
}
...
function Button() {
  return (
    <div className="bg-[#58cc02] h-[60px] relative rounded-[16px] shrink-0 w-full" data-name="button">
      <div aria-hidden="true" className="absolute border-[#46a302] border-b-4 border-solid inset-0 pointer-events-none rounded-[16px]" />
      <p className="-translate-x-1/2 absolute font-['Nunito:Bold',sans-serif] font-bold leading-[24px] left-[168px] text-[16px] text-center text-white top-[18px] tracking-[0.4px] uppercase whitespace-nowrap">set preference</p>
    </div>
  );
}
...
function Container2() {
  return (
    <div className="bg-white h-[156px] relative rounded-[16px] shrink-0 w-[362px]" data-name="Container">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[8px] items-start pb-[2px] pt-[18px] px-[18px] relative size-full">
        <Container3 />
        <P />
        <Button />
      </div>
...
function Container10() {
  return (
    <div className="bg-[#e7e7e7] flex-[1_0_0] min-h-px min-w-px relative rounded-[33554400px] w-[48px]" data-name="Container">
  ...
  return (
    <div className="h-[16px] relative shrink-0 w-[39.578px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start justify-center relative size-full">
        <p className="font-['Nunito:Bold',sans-serif] font-bold leading-[16px] relative shrink-0 text-[#afafaf] text-[12px] whitespace-nowrap">lix</p>
      </div>
    </div>
  );
}
        ...
        <div className="absolute inset-[8.33%]" data-name="Vector">
          <div className="absolute inset-[-5%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12.8333 12.8333">
              <path d={svgPaths.p13f5b400} id="Vector" stroke="var(--stroke-0, #D3D8CF)" strokeDasharray="2.33 2.33" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
            </svg>
          </div>
        </div>
      </div>
...
function Span5() {
  return (
    <div className="h-[16px] relative shrink-0 w-[16.922px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Nunito:Black',sans-serif] font-black leading-[16px] relative shrink-0 text-[12px] text-white whitespace-nowrap">BX</p>
      </div>
    </div>
  );
}
...
function Span6() {
  return (
    <div className="h-[16px] relative shrink-0 w-[39.578px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start justify-center relative size-full">
        <p className="font-['Nunito:Bold',sans-serif] font-bold leading-[16px] relative shrink-0 text-[#afafaf] text-[12px] whitespace-nowrap">Brian</p>
      </div>
    </div>
  );
}
...
function Span7() {
  return (
    <div className="h-[16px] relative shrink-0 w-[16.922px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Nunito:Black',sans-serif] font-black leading-[16px] relative shrink-0 text-[12px] text-white whitespace-nowrap">YU</p>
      </div>
    </div>
  );
}
...
function Span8() {
  return (
    <div className="h-[16px] relative shrink-0 w-[39.578px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start justify-center relative size-full">
        <p className="font-['Nunito:Bold',sans-serif] font-bold leading-[16px] relative shrink-0 text-[#afafaf] text-[12px] whitespace-nowrap">Yulia</p>
      </div>
    </div>
  );
}
...
function Div() {
  return (
    <div className="relative rounded-[33554400px] shrink-0 size-[22px]" data-name="div">
...
function Span9() {
  return (
    <div className="flex-[1_0_0] h-[24px] min-h-px min-w-px relative" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Nunito:Bold',sans-serif] font-bold leading-[24px] left-0 text-[#3c3c3c] text-[16px] top-0 whitespace-nowrap">Invite members</p>
      </div>
    </div>
  );
}
...
function Button2() {
  return (
    <div className="bg-white h-[60px] relative rounded-[16px] shrink-0 w-[362px]" data-name="button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[12px] items-center px-[18px] py-[2px] relative size-full">
        <Div />
        <Span9 />
        <ChevronRight />
      </div>
...
function Span10() {
  return (
    <div className="flex-[1_0_0] h-[24px] min-h-px min-w-px relative" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Nunito:Bold',sans-serif] font-bold leading-[24px] left-0 text-[#3c3c3c] text-[16px] top-0 whitespace-nowrap">Set your preference</p>
      </div>
    </div>
  );
}
...
function Container16() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-[332px] items-start relative shrink-0 w-full" data-name="Container">
      <Button2 />
      <Button3 />
      <Container17 />
      <Container18 />
...
function Container15() {
  return (
    <div className="h-[385px] relative shrink-0 w-[362px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[12px] items-start relative size-full">
        <H2 />
        <Container16 />
      </div>
...
function Container1() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] h-[675px] items-start left-0 pl-[20px] pt-[20px] top-[208px] w-[402px]" data-name="Container">
      <Container2 />
      <Container4 />
      <Container15 />
    </div>
