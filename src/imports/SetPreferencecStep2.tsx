import svgPaths from "./svg-q09kpyddm4";
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Item">
      <div className="content-stretch flex items-start px-[14px] py-[12px] relative w-full">
        <p className="flex-[1_0_0] font-['Balsamiq_Sans:Regular',sans-serif] leading-[24px] min-h-px min-w-px not-italic relative text-[#1a1a1a] text-[16px]">peace</p>
      </div>
    </div>
  );
}
...
function Item1() {
  return (
    <div className="relative shrink-0 w-full" data-name="Item">
      <div className="content-stretch flex items-start px-[14px] py-[12px] relative w-full">
        <p className="flex-[1_0_0] font-['Balsamiq_Sans:Regular',sans-serif] leading-[24px] min-h-px min-w-px not-italic relative text-[#1a1a1a] text-[16px]">walk</p>
      </div>
    </div>
  );
}
...
function Item2() {
  return (
    <div className="relative shrink-0 w-full" data-name="Item">
      <div className="content-stretch flex items-start px-[14px] py-[12px] relative w-full">
        <p className="flex-[1_0_0] font-['Balsamiq_Sans:Regular',sans-serif] leading-[24px] min-h-px min-w-px not-italic relative text-[#1a1a1a] text-[16px]">balanced</p>
      </div>
    </div>
  );
}
...
function Item3() {
  return (
    <div className="relative shrink-0 w-full" data-name="Item">
      <div className="content-stretch flex items-start px-[14px] py-[12px] relative w-full">
        <p className="flex-[1_0_0] font-['Balsamiq_Sans:Regular',sans-serif] leading-[24px] min-h-px min-w-px not-italic relative text-[#1a1a1a] text-[16px]">athlete</p>
      </div>
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="absolute bg-white h-[560px] left-0 overflow-clip rounded-tl-[16px] rounded-tr-[16px] top-[314px] w-[402px]">
      <p className="absolute font-['Lato:Bold',sans-serif] leading-[28px] left-[37px] not-italic text-[20px] text-black top-[44px] whitespace-nowrap">Energy level</p>
      ...
      <div className="absolute bg-white content-stretch flex flex-col items-start left-[32px] px-[2px] py-[8px] rounded-[4px] top-[121px] w-[318px]" data-name="Dropdown Menu">
...
export default function SetPreferencecStep() {
  return (
    <div className="bg-[#e3e3e3] relative size-full" data-name="set preferencec-step 2">
      <Frame4 />
      ...
      <p className="absolute font-['Balsamiq_Sans:Regular',sans-serif] leading-[16px] left-[53px] not-italic text-[14px] text-black top-[176px] uppercase whitespace-nowrap">Avatar, change based on your selection</p>
    </div>
  );
}