  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-[#FFF8E1] to-[#E6F4EA]">
      ...
      <div className="flex flex-col items-center px-6 pt-16 pb-6 text-center">
        <div className="w-24 h-24 rounded-full bg-gradient-to-br from-[#10B954] to-[#0D9443] flex items-center justify-center shadow-[0_6px_0_#2D7800] mb-5">
          <span className="text-4xl" aria-hidden>
            🌍
          </span>
        </div>
        <h1 className="text-[#1F302E] font-black text-2xl leading-tight">
      ...
      {/* Name input */}
      <div className="px-6">
        <label className="block text-xs font-black uppercase tracking-[0.6px] text-[#6B7280] mb-2">
          Your name
        </label>
        <input
          ref={inputRef}
          ...
          className="w-full px-4 py-4 text-base font-bold text-[#1F302E] placeholder:text-[#6B7280] bg-white border-2 border-[#E8E8E8] rounded-2xl shadow-[0_3px_0_#C4C4C4] focus:outline-none focus:border-[#10B954] focus:shadow-[0_3px_0_#0D9443]"
        />
